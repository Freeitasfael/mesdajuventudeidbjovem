CREATE OR REPLACE FUNCTION public.register_seller_self(_name text, _phone text, _church text DEFAULT NULL::text, _neighborhood text DEFAULT NULL::text)
  ...
  IF v_existing_id IS NOT NULL THEN
    UPDATE public.sellers s
       SET name = v_clean_name,
           phone = v_clean_phone,
           church = COALESCE(v_church, s.church),
           neighborhood = COALESCE(v_neigh, s.neighborhood)
